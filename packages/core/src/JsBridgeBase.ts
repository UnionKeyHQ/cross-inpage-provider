...
import type { Web3ProviderError } from '@unionkeyfe/cross-inpage-provider-errors';
import { web3Errors, toNativeErrorObject } from '@unionkeyfe/cross-inpage-provider-errors';
import {
  IDebugLogger,
