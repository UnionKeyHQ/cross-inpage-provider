...
import { injectedFactory, JsBridgeBase } from '@unionkeyfe/cross-inpage-provider-core';
import { IJsBridgeConfig, IJsBridgeMessagePayload } from '@unionkeyfe/cross-inpage-provider-types';
